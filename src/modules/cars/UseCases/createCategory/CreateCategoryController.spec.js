...
describe("Create Category Controller", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, supertest_1.default(app_1.app).post("/categories").send({
    ...
    it("should not be be able to create a new category with name exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, refresh_token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app_1.app).post("/sessions").send({
