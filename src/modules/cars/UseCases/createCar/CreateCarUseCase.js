            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.carsRepository.create({ name: name, description: description, daily_rate: daily_rate, license_plate: license_plate, fine_amount: fine_amount, brand: brand, category_id: category_id })];
                    case 2:
                        car = _b.sent();
                        return [2 /*return*/, car];
                }
